...
class AffichageController extends AbstractController
{
    ...
    public function affichageEntreprise(Request $request)
    {
        ...
        if($idEntreprise!=null)
        {
            ...
            {
                $liste_formation[]=['tag'=>$formation->getTag()];
            }
            ...
            foreach ($candidatures as $candidature)
            {
                ...
                $formations_candidature[$candidature->getFormation()->getTag()][]=['moyen'=>$candidature->getMoyen(),'etat'=>$candidature->getEtat(),'reponse'=>$candidature->getReponse()];
            }
